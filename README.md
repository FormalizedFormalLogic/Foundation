...
Diagrams "Zoo" illustrate the Lean 4-verified interrelationships among theories and logics.
They are generated by [`Zoo/`](./Zoo); run `just zoo` to regenerate them locally.
