...
- *Sound*: $\N \models \mathrm{Provable}_T(\ulcorner \varphi \urcorner) \implies T \vdash \varphi$
  ```lean
  lemma LO.FirstOrder.Arithmetic.Bootstrapping.Language.Theory.Provable.sound :
      (T.codeIn ℕ).Provable ⌜p⌝ → T ⊢ p
  ```
  - [LO.FirstOrder.Arithmetic.Bootstrapping.Language.Theory.Provable.sound](https://formalizedformallogic.github.io/Foundation/doc/Foundation/FirstOrder/Incompleteness/StandardProvability/D1.html#LO.FirstOrder.Arithmetic.Bootstrapping.Language.Theory.Provable.sound)
- _D1_: $T \vdash \varphi \implies V \models \mathrm{Provable}_T(\ulcorner \varphi \urcorner)$
  ```lean
  theorem LO.FirstOrder.Arithmetic.Bootstrapping.provable_of_provable :
      T ⊢ p → (T.codeIn V).Provable ⌜p⌝
  ```
  - [LO.FirstOrder.Arithmetic.Bootstrapping.provable_of_provable](https://formalizedformallogic.github.io/Foundation/doc/Foundation/FirstOrder/Incompleteness/StandardProvability/D1.html#LO.FirstOrder.Arithmetic.Bootstrapping.provable_of_provable)
...
- *Formalized $\Sigma_1$-completeness*: Let $\sigma$ be a $\Sigma_1$-sentence. $V \models \sigma \implies
  ...
  ```lean
  theorem LO.FirstOrder.Arithmetic.Bootstrapping.sigma1_complete (hσ : Hierarchy 𝚺 1 σ) :
      V ⊧ₘ σ → T.Provable ⌜σ⌝
  ```
  - [LO.FirstOrder.Arithmetic.Bootstrapping.sigma1_complete](https://formalizedformallogic.github.io/Foundation/doc/Foundation/FirstOrder/Incompleteness/StandardProvability/D3.html#LO.FirstOrder.Arithmetic.Bootstrapping.sigma1_complete)
