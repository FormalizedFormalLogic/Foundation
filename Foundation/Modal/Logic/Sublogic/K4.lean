...
instance : ProperSublogic Logic.K4 Logic.K4Point2 := ⟨by
  ...
  . suffices ∃ φ, Hilbert.K4Point2 ⊢! φ ∧ ¬Kripke.FrameClass.transitive ⊧ φ by simpa [K4.eq_TransitiveKripkeFrameClass_Logic];
...
instance : ProperSublogic Logic.K4 Logic.K4Point3 := ⟨by
  constructor;
  . exact Hilbert.weakerThan_of_dominate_axioms (by simp) |>.subset;
  . suffices ∃ φ, Hilbert.K4Point3 ⊢! φ ∧ ¬Kripke.FrameClass.transitive ⊧ φ by simpa [K4.eq_TransitiveKripkeFrameClass_Logic];
