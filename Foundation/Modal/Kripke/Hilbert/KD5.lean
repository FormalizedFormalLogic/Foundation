...
instance Kripke.canonical : Canonical (Hilbert.KD5) (SerialEuclideanFrameClass) := ⟨⟨Canonical.serial, Canonical.euclidean⟩⟩

instance Kripke.complete : Complete (Hilbert.KD5) (SerialEuclideanFrameClass) := inferInstance
