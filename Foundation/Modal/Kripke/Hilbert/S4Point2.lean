...
instance Kripke.sound : Sound (Hilbert.S4Point2) (ReflexiveTransitiveConfluentFrameClass) := by
...
instance Kripke.canonical : Canonical (Hilbert.S4Point2) (ReflexiveTransitiveConfluentFrameClass) := ⟨⟨Canonical.reflexive, Canonical.transitive, Canonical.confluent⟩⟩

instance Kripke.complete : Complete (Hilbert.S4Point2) (ReflexiveTransitiveConfluentFrameClass) := inferInstance
