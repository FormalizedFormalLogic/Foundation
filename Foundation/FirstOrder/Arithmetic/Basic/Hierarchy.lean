...
abbrev rec := @Bounding.Hierarchy.rec (ℬ := bounding (L := L))

abbrev recOn := @Bounding.Hierarchy.recOn (ℬ := bounding (L := L))

abbrev casesOn := @Bounding.Hierarchy.casesOn (ℬ := bounding (L := L))

abbrev below := @Bounding.Hierarchy.below (ℬ := bounding (L := L))

abbrev brecOn := @Bounding.Hierarchy.brecOn (ℬ := bounding (L := L))
