...
lemma models_iff_of_Sigma0 {n : ℕ} {σ : ArithmeticSemisentence n} (hσ : Hierarchy 𝚺 0 σ) {e : Fin n → ℕ} :
...
lemma models_iff_of_Delta1 {n : ℕ} {σ : 𝚫₁.Semisentence n} (hσ : σ.ProperOn ℕ) (hσV : σ.ProperOn V) {e : Fin n → ℕ} :
...
theorem sigma_one_completeness_iff_param {n : ℕ} {σ : ArithmeticSemisentence n} (hσ : Hierarchy 𝚺 1 σ) {e : Fin n → ℕ} :
